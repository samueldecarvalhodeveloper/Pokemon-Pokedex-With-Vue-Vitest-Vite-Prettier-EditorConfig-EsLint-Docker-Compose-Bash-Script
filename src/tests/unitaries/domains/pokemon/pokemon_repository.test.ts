...
describe("Test Class PokemonRepository", () => {
  ...
  test('Test If Method "getPokemonMatrix" Returns Matrix Of Pokemons Data From Service', async () => {
  ...
  test('Test If Method "getPokemon" Returns Pokemon Data From Service', async () => {
    (axios.get as Mock).mockResolvedValueOnce({
